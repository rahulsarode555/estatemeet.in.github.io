<%@ Page Title="1 BHK 2 BHK 3 BHK Flat in Pre Launching Up Coming Under Construction Projects in Pimpri-Chinchwad - Buy Flat Residential / Office, Shop Commercial Property in Pimpri Chinchwad PCMC Pune" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Buy_Property_Mobile.aspx.cs" Inherits="Buy_Property_Mobile" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    
    <meta name="description" content="Buy Residential / Commercial Property in Pimpri-Chinchwad. On estate meet you can Buy Flat, Office, Shop, Restaurant Space - Pimpri-Chinchwad. www.estatemeet.in 1 BHK 2 BHK 3 BHK Flat in Pre launching up coming under construction Projects in Pimpri-Chinchwad" />
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <div class="searchTabMobile" >        
        ...
        <asp:DropDownList ID="lst_Construction_Status" runat="server" class="listAtt" AutoPostBack="True"  OnSelectedIndexChanged="refresh_Page" >
            <asp:ListItem Value="all"> All </asp:ListItem>
        ...
        <asp:DropDownList ID="lst_Budget_Min" runat="server" class="listAtt" AutoPostBack="True"  OnSelectedIndexChanged="change_Budget" DataSourceID="SqlDataSource1" DataTextField="Value" DataValueField="ID" >
        ...
        <asp:DropDownList ID="lst_Budget_Max" runat="server" class="listAtt" AutoPostBack="True"  OnSelectedIndexChanged="refresh_Page" DataSourceID="SqlDataSource2" DataTextField="Value" DataValueField="ID" >
        ...
        <asp:DropDownList ID="lst_Sale_Type" runat="server" class="listAtt" AutoPostBack="True"  OnSelectedIndexChanged="refresh_Page" >
            <asp:ListItem Value="all"> All </asp:ListItem>
