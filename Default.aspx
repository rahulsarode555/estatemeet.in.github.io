<%@ Page Title="Real Estate Consultant and Agent /Channel Partner in PCMC / pune - Home" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs"
    Inherits="_Default" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content" runat="server">
    <div style="background-color:#b1b6ed">
