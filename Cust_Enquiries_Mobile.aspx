<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Cust_Enquiries_Mobile.aspx.cs" Inherits="Cust_Enquiries_Mobile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <asp:Label ID="lbl_Message" runat="server"></asp:Label>

    <div class="searchTabMobile" style="padding:20px;">
        Property Type :
