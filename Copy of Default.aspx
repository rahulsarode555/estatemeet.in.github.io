<%@ Page Title="Real Estate Consultant and Agent /Channel Partner in PCMC / pune - Home" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Copy of Default.aspx.cs"
    Inherits="_Default" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content" runat="server">
    <div style="background-color:#e1e3f6">
    ...
    <center>
        ...
        <div class="container1" style="border: 0px solid red; margin-top: 0px;">
            ...
            <div class="leftDiv zoom">
                <a href="Properties_For_Rent.aspx" class="tablink sub_Div_Link">PROPERTIES ON RENT
                </a>
